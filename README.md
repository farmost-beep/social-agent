...
通过 [cc-connect](https://github.com/chenhg5/cc-connect) 桥接，在微信中直接与 AI 管家对话。cc-connect 支持飞书/Telegram/Slack/钉钉/Discord/LINE/企业微信/个人微信/QQ 等多平台，可同时管理多个项目。
...
<details>
<summary><b>备选桥接：wechat-claude-code</b>（点击展开）</summary>

[wechat-claude-code](https://github.com/Wechat-ggGitHub/wechat-claude-code) 是另一款微信桥接工具，专注微信单一平台，通过 iLink API 发送。
...
发送优先级：cc-connect 桥接（需绑定 wxid，最可靠）→ AppleScript 控制 Mac 微信（备用）。
